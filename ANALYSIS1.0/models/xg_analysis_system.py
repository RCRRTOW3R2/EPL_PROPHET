...
class RollingXGAnalyzer:
    ...
    def calculate_match_xg(self, shots, shots_on_target, corners, is_home=False):
    ...
    def calculate_xg_for_match(self, match_row):
    ...
    def get_team_matches_before_date(self, df, team, before_date, num_matches=None):
    ...
    def calculate_rolling_xg_form(self, df, team, before_date, window):
    ...
    def create_match_xg_features(self, df, match_idx):
        ...
        for window_name, window_size in [('short', self.short_window), ('medium', self.medium_window), ('long', self.long_window)]:
...
def process_xg_analysis(data_path):
...
def create_team_xg_summary(xg_features_df):
